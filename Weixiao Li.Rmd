...
```
## The mean time of runing each station

```{r}
B11 <- dplyr::filter(nTravel,direction_id==0&to_stop_id==min(b$to_stop_id))
b70002 <- dplyr::filter(B11,B11$from_stop_id=="70002")
m70002 <- mean(b70002$travel_time_sec)
```
...
# Between each stop and the average of 70001
```{r}
