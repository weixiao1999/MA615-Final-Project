...
DAY <- c("Nov-2021","Dec-2021","Jan-2022","Feb-2022","Mar-2022","Apr-2022","May-2022","Jun-2022","Jul-2022","Aug-2022","Sep-2022")
DF1 <- data.frame(x = DAY, y = meantime )
ggplot(data = DF1, mapping = aes(x =meantime, y = DAY)) + geom_bar(stat="identity",fill="lightblue")+ggtitle("From Start to Finish")
...
or70279 <- dplyr::filter(Or,Or$from_stop_id=="70279")
orange70279 <- mean(or70279$travel_time_sec)
```
