...
a16_1 <- dplyr::filter(a15,direction_id==0)
a16_2<- dplyr::filter(a15_1,to_stop_id==min(a15_1$to_stop_id))
a16_3 <- dplyr::filter(a15_2,end_time_sec==min(a15_2$end_time_sec))
a16_4<-dplyr::arrange(a15_3,travel_time_sec)
a16 <- max(a15_4$travel_time_sec)
```
